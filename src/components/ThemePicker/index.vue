...
export default {
  name: 'ThemePicker',
  props: {
    default: { // Initial theme, can be passed from outside
      type: String,
      default: null
    },
    size: { // Initial theme, can be passed from outside
      type: String,
      default: 'small'
    }
  },
  data() {
    return {
      ...
      showSuccess: true // Whether to show skin change success message
    }
  },
  mounted() {
  ...
  watch: {
    theme(val, oldVal) {
      ...
      // Replace CSS styles, change theme color
